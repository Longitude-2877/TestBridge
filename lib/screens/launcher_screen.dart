...
class _LauncherScreenState extends State<LauncherScreen> {
  ...
  Future<void> _load() async {
    ...
    final unread = await HomeItemsStore.unreadMessageCount();
    if (!mounted) return;
    setState(() {
      _apps = apps;
      _quick = quick;
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Icon(Icons.add_circle_rounded,
                                            color: ContraTheme.blue, size: 28),
                                      ],
                                    ),
                                  ),
                                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          // Requirement 14: scroll bars on the left side of the home screen.
          Column(
            children: [
              Expanded(
                child: _ScrollBar(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            if (addedIndex < _apps.length) {
                              ...
                              return _AppRow(
                                ...
                                leading: icon != null
                                    ...
                                    : _LetterTile(
                                        name: app.name, color: Colors.white),
                                name: app.name,
                            ...
                            return _AppRow(
                              ...
                              leading: quick.photoPath != null
                                  ...
                                  : _LetterTile(
                                      name: quick.name, color: Colors.white),
                              name: quick.name,
...
class _ScrollBar extends StatelessWidget {
  final IconData icon;
  final VoidCallback onTap;
  const _ScrollBar({required this.icon, required this.onTap});

  @override
  Widget build(BuildContext context) {
    return Material(
      color: ContraTheme.border,
      borderRadius: BorderRadius.circular(14),
      child: LongPressInk(
        onTap: onTap,
        borderRadius: BorderRadius.circular(14),
...
class _AppRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final iconH = small ? 52.0 : 60.0;
    return Material(
      color: ContraTheme.card,
      borderRadius: BorderRadius.circular(18),
      elevation: 1,
      // Requirement: white card with a black border.
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(18),
        side: const BorderSide(color: ContraTheme.border, width: 2),
      ),
      child: LongPressInk(
        onTap: onTap,
        borderRadius: BorderRadius.circular(18),
